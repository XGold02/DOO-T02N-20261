...
public class Loja {
	...
	private static void contarVendedores(LojaDados loja) {
	...
	private static void contarClientes(LojaDados loja) {
	...
	private static void cadastrarLoja() {
		...
		LojaDados loja = new LojaDados(nomeFantasia, razaoSocial, cnpj, endereco, null, null);
