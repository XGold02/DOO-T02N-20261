...
public class Index {
    ...
    public static void IniciaBase() {
        ...
        double[] SLVendedor1 = {1500, 2000, 2300};
        double[] SLVendedor2 = {2000, 2500, 3000};


        Vendedor vendedor1 = new Vendedor("Jorge", 25, "Matriz", 
        "Cascavel", "Centro", "Av. Brasil", SLVendedor1[0], SLVendedor1);

        Vendedor vendedor2 = new Vendedor("Pedro", 35, "Filial 1", 
        "Cafelandia", "Centro", "Av. Novo Mundo", SLVendedor2[0], SLVendedor2);

        Cliente cliente1 = new Cliente("Andressa", 24, 
        "Cafelandia", "Centro", "Girassol");

        Cliente cliente2 = new Cliente("Joao", 34, 
        "Cascavel", "Centro", "Don Pedro");
        
        for (int i=0; i >= vendedores.size(); i++) {
            if (vendedores.get(i).loja == "Matriz") {
        ...
        Loja loja1 = new Loja("Flores pra Voce", "Matriz", "12.345.678/0001-90", 
        "Cascavel", "Centro", "Rua 1", LMatriz, "Andressa");
